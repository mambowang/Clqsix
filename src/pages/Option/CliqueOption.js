...
class CliqueOption extends Component {
    ...
    return (
      <FullScreen style={{alignItems: 'center', backgroundColor: '#ffffff',}}>
        ...
        <CustomNavigator
          ...
          rightButton = {<Image source={Images.Friends_1200x1200} style = {{width:24,height:24}}/>}      
        ...
        <FullScreen.Row style={styles.topview}>
            <View >
              <Text style={styles.topfont}>Collaborate with </Text>
              <Text style={styles.topfont}>squads everywhere</Text>
            </View>
        </FullScreen.Row>
        ...
        <FullScreen.Row style={[styles.contentrow,{borderTopWidth: 0}]} >
          ...
          onPress={() => { this.props.navigation.navigate('ViewRequest')}}>          
            <Image source={Images.Profile_15x15}/>         
            <View style = {styles.contenttextview} >
                <Text style = {styles.contenttext}>View Member Requests</Text>
            </View>          
            <Image source={Images.right_go_6x10}/>         
          </TouchableOpacity>          
        </FullScreen.Row> 
